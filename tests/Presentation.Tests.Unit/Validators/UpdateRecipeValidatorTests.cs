...
using CookBookApi.Presentation.Validators;
using Xunit;
...
{
    private static readonly UpdateRecipeValidator Validator = new();
    ...
    public void Validator_ShouldNotHaveValidationErrorFor_ValidRequest()
    {
        ...
        var request = new UpdateRecipeRequest
        {
            ...
            RecipeLineItems = new List<UpdateRecipeLineItemRequest>
            {
                new()
                {
